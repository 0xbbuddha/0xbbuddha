...
<p align="center">
  SOC Analyst / SOC Builder apprentice. Big fan of open-source.<br>
  Wannabe red teamer.
</p>
...
![Quickshell](https://img.shields.io/badge/Quickshell-FF6B35?style=flat-square&logo=qt&logoColor=white)
![Kitty](https://img.shields.io/badge/Kitty-1F1F1F?style=flat-square)
![Zellij](https://img.shields.io/badge/Zellij-1A1A2E?style=flat-square)
![Helix](https://img.shields.io/badge/Helix-281733?style=flat-square)
...
| [Wazuh-cli](https://github.com/0xbbuddha/Wazuh-cli) | Interactive TUI REPL for the Wazuh REST API | `go` |
| [Nihil](https://github.com/TheNullPigeons/Nihil) | Minimal offensive security environment via Docker | `shell` |
| [ArchimedeaOS](https://github.com/ArchimedeaOS-Development) | Arch Linux-based purple team distribution | `shell` |
